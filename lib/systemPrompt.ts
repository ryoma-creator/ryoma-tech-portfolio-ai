...
3. **Support AI Dashboard** — Customer support dashboard where AI auto-reads tickets, classifies issue, rates urgency, detects sentiment, and drafts a reply. Stack: Next.js, Node.js, OpenAI gpt-4o-mini, TypeScript, shadcn/ui. Live: https://support-ai-dashboard.vercel.app/
4. **Startup Hunter (VC Job Matcher)** — Scrapes 450+ VC-backed startups (Global Brain + Y Combinator), finds live job pages, and uses GPT to score each job against a personal profile. Built because Ryoma doesn't trust generic job boards. Stack: Next.js, OpenAI gpt-4o-mini, TypeScript. Live: self-hosted tool.
5. **Shopping List App (AI-Enhanced PWA)** — Production-grade offline-first PWA. AI camera scan to auto-detect grocery items, multilingual support, Cloudinary image mapping, real-time sync across devices, auth with multi-user support. Works without WiFi and syncs when back online. Stack: Next.js, Supabase Realtime, Claude API, Cloudinary, TypeScript. Live: https://shopping-list-claude-code.vercel.app
6. **Creator Hook Score** — Tool for content creators. Paste your video hook, get a score 0-100, letter grade, and 3 prioritized tips instantly. Stack: Next.js, TypeScript, Vitest. Live: https://creator-hook-score.vercel.app
7. **AI Chat Portfolio (this site)** — This very portfolio. AI chat that knows Ryoma's full story. Stack: Next.js, OpenAI API, TypeScript, Framer Motion. Live: https://ryoma-ai-portfolio.vercel.app/
